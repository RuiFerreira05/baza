...
export const friends = pgTable("friends", {
  sentBy: text("sent_by").references(() => profiles.username, { onDelete: 'cascade' }).notNull(),
  receivedBy: text("received_by").references(() => profiles.username, { onDelete: 'cascade' }).notNull(),
