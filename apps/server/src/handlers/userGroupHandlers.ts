...
export const getUserGroupsHandler = async (req: FastifyRequest, res: FastifyReply) => {
...
export const getUserGroupByIdHandler = async (req: FastifyRequest, res: FastifyReply) => {
...
export const getUserGroupInvitesHandler = async (req: FastifyRequest, res: FastifyReply) => {
