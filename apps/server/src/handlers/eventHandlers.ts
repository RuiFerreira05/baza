...
export const createGroupEventHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
...
export const getGroupEventsHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
...
export const getGroupEventByIdHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
...
export const editGroupEventHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
...
export const resolveTieHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
  ...
  if (!result.ok) {
    ...
    return res
      .status(200)
      .send(createStatusOK({ message: "Tie successfully resolved." }));
  }
};

// GET /groups/:id/calendar
export const getGroupCalendarHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
    ...
    switch (result.error) {
      case ErrorTypes.UnknownIdError:
        return res
          .status(404)
          .send(
            createStatusError(ErrorTypes.UnknownIdError, "Group not found."),
          );
...
export const getPersonalEventsHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
...
export const getPersonalEventByIdHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
...
export const createPersonalEventHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
...
export const editPersonalEventHandler = async (
  req: FastifyRequest,
  res: FastifyReply,
) => {
