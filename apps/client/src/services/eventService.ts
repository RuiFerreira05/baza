...
export const eventService = {
  ...
  getPersonalEvent: (username: string, idEvent: string) =>
    apiClient<PersonalEventDTO>(
      `/v1/restricted/users/${username}/events/${idEvent}`,
    ),
  ...
  getGroupEvent: (groupId: string, idEvent: string) =>
    apiClient<GroupEventDTO>(
      `/v1/restricted/groups/${groupId}/events/${idEvent}`,
    ),
  ...
  confirmEventAttendance: (groupId: string, idEvent: string) =>
    apiClient<EventConfirmationDTO>(
  ...
  getGroupPreferenceReport: (groupId: string, idEvent: string) =>
    apiClient<GroupPreferenceReportDTO>(
