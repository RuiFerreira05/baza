...
export const planService = {
  ...
  getPlans: (groupId: string, idEvent: string) =>
    apiClient<PlanDTO[]>(`/v1/restricted/groups/${groupId}/events/${idEvent}/plans`),
  ...
  getPlan: (groupId: string, idEvent: string, idPlan: string) =>
    apiClient<PlanDTO>(`/v1/restricted/groups/${groupId}/events/${idEvent}/plans/${idPlan}`),

  // PATCH /v1/restricted/groups/:id/events/:idevent/plans/:idplan
  editPlan: (groupId: string, idEvent: string, idPlan: string, body: EditPlanBody) =>
    apiClient<PlanDTO>(`/v1/restricted/groups/${groupId}/events/${idEvent}/plans/${idPlan}`, {
      method: "PATCH",
      json: body,
    }),
  ...
  submitVote: (groupId: string, idEvent: string, idPlan: string) =>
    apiClient<{ message: string }>(`/v1/restricted/groups/${groupId}/events/${idEvent}/plans/${idPlan}/votes`, {
      method: "POST",
    }),
